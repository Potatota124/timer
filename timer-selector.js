...
var TRANSLATIONS = {
  ...
  'vi': {
    ...
    'deletion-options': 'Lựa chọn Xóa bỏ', // TODO
    'deletion-score': 'Điểm số hiện tại của Bài viết', // TODO
    'summary-deletion-reasons': [],
    'duration': 'Thời gian',
    'duration-1d': '1 Ngày',
    'duration-1w': '1 Tuần',
    ...
    'build-and-copy-timer': 'Dựng và sao chép đồng hồ',
    'info-help': 'trợ giúp',
    'info-source': 'mã nguồn',
    'error-missing': 'Hãy chọn đầy đủ các tùy chọn bắt buộc',
    'error-invalid': 'Lỗi công cụ, vui lòng gửi báo cáo lỗi.',
  },
